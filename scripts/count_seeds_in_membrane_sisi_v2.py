...
def count_abs_in_membrane(ab_filename, seed_filename):
	...
	return len(culled_ab_points_array_on_edge), average_pairwise_distance 
...
for time_dir in time_dirs:	
	...
	for i in range(len(ab_file_list)):
		...
		#try:
		ab_membrane_count, seed_pairwise_distance_avg = count_abs_in_membrane(ab_full_file, seed_full_file)
