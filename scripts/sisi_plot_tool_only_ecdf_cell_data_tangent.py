...
plt.xlabel('mean tangent angular displacement (1 pixel step size)')
plt.ylabel('ecdf (step function)')
plt.title('mean tangent angular displacement ecdf (cell data, 1 pixel step size)')
plt.legend( loc=4 )
plt.savefig('tangent_cell_distributions_ecdf_cell_expt_matching_values.pdf')
plt.close()
